...
const SellableButton = ({ buyLoading, buyGradient }: SellableButtonProps) => (
  ...
  <button disabled={buyLoading} onClick={buyGradient} className={`md:w-auto w-full bg-black text-white my-3 h-100 py-3 px-20 font-semibold rounded-lg shadow-md ${buyLoading ? "cursor-not-allowed bg-gray-700" : "hover:bg-gray-700"} `}>
    {buyLoading ? (
      <div>
